...
// In both cases, import "launchpad.net/account-polld/plugins/imap/text/transform".
//
// Encoding implementations are provided in other packages, such as
// launchpad.net/account-polld/plugins/imap/text/encoding/charmap and
// launchpad.net/account-polld/plugins/imap/text/encoding/japanese.
package encoding // import "launchpad.net/account-polld/plugins/imap/text/encoding"

import (
	"errors"
	"unicode/utf8"

	"launchpad.net/account-polld/plugins/imap/text/transform"
)
