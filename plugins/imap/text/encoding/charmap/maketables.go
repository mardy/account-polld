...
func main() {
	...
	fmt.Printf("import (\n")
	fmt.Printf("\t\"launchpad.net/account-polld/plugins/imap/text/encoding\"\n")
	fmt.Printf("\t\"launchpad.net/account-polld/plugins/imap/text/encoding/internal/identifier\"\n")
	fmt.Printf(")\n\n")
