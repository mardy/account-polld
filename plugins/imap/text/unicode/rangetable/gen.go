...
import (
	...
	"launchpad.net/account-polld/plugins/imap/text/internal/gen"
	"launchpad.net/account-polld/plugins/imap/text/internal/ucd"
	"launchpad.net/account-polld/plugins/imap/text/unicode/rangetable"
)
